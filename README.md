# Optimizing Large File Upload Performance Project
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create optimizing-upload-performance-remix-7800
  fly apps create optimizing-upload-performance-remix-7800-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app optimizing-upload-performance-remix-7800
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app optimizing-upload-performance-remix-7800-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'optimizing-upload-performance-remix-7800-staging' does not match app name in config file 'optimizing-upload-performance-remix-7800'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name optimizing-upload-performance-remix-7800-db
  fly postgres attach --app optimizing-upload-performance-remix-7800 optimizing-upload-performance-remix-7800-db

  fly postgres create --name optimizing-upload-performance-remix-7800-staging-db
  fly postgres attach --app optimizing-upload-performance-remix-7800-staging optimizing-upload-performance-remix-7800-staging-db
  ```
